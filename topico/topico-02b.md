...
#### <ins>EXERCÍCIO:</ins> No contexto das operações UNIÃO, INTERSEÇÃO e DIFERENÇA, para comparar as _tuplas_ presentes nas duas relações de entrada, as _tuplas_ devem ser do mesmo tipo, ou seja, deve haver 'compatibilidade de união' (compatibilidade de tipo). O que significa 'compatibilidade de u
